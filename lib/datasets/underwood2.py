...
class underwood(imdb):
    ...
    def _load_image_set_index(self):
        ...
        # self._devkit_path + /apples/sets/val.txt
    ...
    def _get_default_path(self):
        ...
        """
        return os.path.join(cfg.DATA_DIR, 'underwood_dataset')
    ...
    def _load_underwood_annotation(self, index):
        """
    ...
    def write_underwood_results_file(self, all_boxes, epoch, im):
